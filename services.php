...
<div style="background-color:grey; padding: 40px 20px;">
  <div class="row">
    <div class="col-sm-4 team-member">
      <img src="https://scontent.fceb2-2.fna.fbcdn.net/v/t39.30808-6/524172305_1080445137510803_7636828681874666329_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeGyeSB7DgNWrHlRSXo9tIHtNF7g-RrfIDU0XuD5Gt8gNRHkSRik5F_XpfQlMyY0lJ2e2Dqa5yhsDtuLaJrYlFhm&_nc_ohc=-e_BhT7ROfYQ7kNvwFJAcdz&_nc_oc=AdmVIzznHzom9_KPpfdH4ccX0EYMEn-pWn9TsTd3WHzVfKJ9-bvSiUQhuf0wldIB_oU&_nc_zt=23&_nc_ht=scontent.fceb2-2.fna&_nc_gid=b3IoIOfmTeZxMZqycD_vGQ&oh=00_AfWsAAIQH9mMaqcVTakVBbTvsjD8l7pTZFmjxxdrPFRUrA&oe=689A02DB" width="140" height=" 140" class="img-circle" alt="Cinque Terre" >
      <h3>MICKY JABINAR</h3>
      <p>Founder</p>
      <p>Sets the culture and values of the organization. Plays a crucial role in fundraising and networking.</p>
    </div>
    <div class="col-sm-4 team-member">
    <img src="https://scontent.fceb6-1.fna.fbcdn.net/v/t39.30808-6/494904943_709026738354670_6688066168037716283_n.jpg?stp=dst-jpg_s960x960_tt6&_nc_cat=105&ccb=1-7&_nc_sid=cc71e4&_nc_eui2=AeGW4gTzTLOJaGuUeBkeoqn1qTkIo42H552pOQijjYfnnWOBbsRly8qXlxZpYwv3CLZph_dOsDyIpt2pCtYZiAX-&_nc_ohc=RoqigX_-bmAQ7kNvwGjsBPm&_nc_oc=AdnMTEhD2DHmgi1-Rqy_LDiN8pf0p4Z7kh6hG6sthFmxOgzllOapTebUrUNGtp99PvY&_nc_zt=23&_nc_ht=scontent.fceb6-1.fna&_nc_gid=8e-kaKd3GzoKxnoCei1xnA&oh=00_AfU4gJXvubkAxCddR_BcaC0yjPL2pPqydXzUQjm-f4WlyQ&oe=689A0641"  width="140" height=" 140" class="img-circle" alt="Cinque Terre">
      <h3>NATH ALVARADO</h3>
